...
class SwcnTreeReconf:
    ...
    def tree_update(self, current=nx.DiGraph(), init_subtree=nx.DiGraph(), end_subtree=nx.DiGraph()):
        ...
        for n in ex_end:
            curr.nodes[n]['node_data'] = end_subtree.nodes[n]['node_data'] # Ajouter les propri�t�s des noeuds � l'arbre courant
           # curr.add_node(n)
    ...
    def _is_fulfil_notree_cond(self, t0=nx.DiGraph(), tz=nx.DiGraph(), conv_node="0", div_node="0"):
        ...
        # ancetres convergents  de conv_node situé sur div_node->conv_node de Tz
        ancestorsz_conv = set(pathz[1:len(pathz)-1]).intersection(nsp.get_convergents(t0,tz,div_node))
        if len(ancestorsz_conv) != 0:
            ...
            if len(ancestors0) == 0:
                ...
                # ancetres convergents  de conv_node situé sur div_node->conv_node de Tz qui ne sont
    ...
    def test1(self):
        ...
        T0_edges = [('4', '5'),  ('5', '13'), ('3', '4'), ('3', '1'), ('10', '11'), ('10', '3'), ('8', '12'), ('12', '10'), ('1', '2')]
        T0.add_edges_from(T0_edges)
        Tz_edges = []
        wcn_nodes_list = ['3','10']
        attrs = dict()
        print('TEST1')
