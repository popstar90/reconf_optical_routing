...
def get_childs(T=nx.DiGraph(), node):
    """
...
def get_parent(T=nx.DiGraph(), node):
    """
...
def is_convergent(T0=nx.DiGraph(),Tz=nx.DiGraph(),node):
    """
...
def is_divergent(T0=nx.DiGraph(),Tz=nx.DiGraph(),node):
    """
...
def get_convergents(T0=nx.DiGraph(),Tz=nx.DiGraph(),node):
    """
...
def get_divergents(T0=nx.DiGraph(),Tz=nx.DiGraph(),node):
    """
